...
CUSTOM_POSTER_DIR = os.path.join(CONFIG_DIR, 'custom_posters')
...
# Thread locks for cache safety (prevent race conditions)
...
def set_history_cache(key, candidates):
    """Set history cache entry (thread-safe)"""
    with HISTORY_CACHE_LOCK:
